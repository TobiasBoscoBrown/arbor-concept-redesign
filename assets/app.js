...
(function(){
  ...
  window.ARBOR_PRODUCTS = {
    ...
    "p3":{name:"Matte Black Cabinet Pull Set (10)",cat:"Hardware",price:34,was:0,rating:4,tag:"",icon:"hardware",desc:"Set of ten solid-zinc cabinet pulls in a soft matte-black finish. 5-inch hole spacing with mounting screws included. A fast, high-impact upgrade for kitchens and baths."},
    "p4":{name:"Premium Interior Paint — Sage",cat:"Paint",price:42,was:0,rating:5,tag:"Low VOC",tagGreen:true,icon:"paint",desc:"Low-VOC interior paint and primer in one, in a soft heritage sage. Washable matte finish with excellent coverage. One gallon covers up to 400 square feet."},
    "p5":{name:"Cedar Raised Garden Bed Kit",cat:"Lawn & Garden",price:129,was:159,rating:5,tag:"",icon:"garden",desc:"Naturally rot-resistant western cedar raised bed. Tool-free corner brackets, a 4x4 footprint and 11 inches of depth. Ships flat and assembles in minutes."},
    "p6":{name:"Frameless LED Bathroom Mirror",cat:"Bath & Faucet",price:215,was:0,rating:4,tag:"New",icon:"mirror",desc:"Frameless wall mirror with built-in anti-fog LED lighting and a touch dimmer. Hardwired or plug-in, with vertical or horizontal mounting."},
    "p7":{name:"Soft-Close Drawer Slide Pair",cat:"Hardware",price:18,was:24,rating:5,tag:"",icon:"hardware",desc:"Pair of full-extension, soft-close ball-bearing drawer slides rated to 100 lbs. Side-mount, 18-inch length with screws included."},
    "p8":{name:"Luxury Vinyl Plank — Coastal Grey",cat:"Flooring",price:3.19,unit:"/sq ft",was:0,rating:5,tag:"Trade Price",icon:"floor",desc:"Waterproof rigid-core luxury vinyl plank in a weathered coastal grey. 20-mil wear layer with attached underlayment and a click-lock install. Sold by the square foot."}
  };
