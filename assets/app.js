...
(function(){
  ...
  window.ARBOR_PRODUCTS = {
    "p1":{name:"Heritage Oak Engineered Flooring",cat:"Flooring",price:4.29,unit:"/sq ft",was:5.49,rating:5,tag:"Trade Price",icon:"floor"},
    "p2":{name:"Brushed Brass Kitchen Faucet",cat:"Bath & Faucet",price:189,was:249,rating:5,tag:"Best Seller",tagGreen:true,icon:"faucet"},
    "p3":{name:"Matte Black Cabinet Pull Set (10)",cat:"Hardware",price:34,was:0,rating:4,tag:"",icon:"hardware"},
    "p4":{name:"Premium Interior Paint — Sage",cat:"Paint",price:42,was:0,rating:5,tag:"Low VOC",tagGreen:true,icon:"paint"},
    "p5":{name:"Cedar Raised Garden Bed Kit",cat:"Lawn & Garden",price:129,was:159,rating:5,tag:"",icon:"garden"},
    "p6":{name:"Frameless LED Bathroom Mirror",cat:"Bath & Faucet",price:215,was:0,rating:4,tag:"New",icon:"mirror"},
    "p7":{name:"Soft-Close Drawer Slide Pair",cat:"Hardware",price:18,was:24,rating:5,tag:"",icon:"hardware"},
    "p8":{name:"Luxury Vinyl Plank — Coastal Grey",cat:"Flooring",price:3.19,unit:"/sq ft",was:0,rating:5,tag:"Trade Price",icon:"floor"}
  };
